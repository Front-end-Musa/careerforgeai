...
import {
  ...
  ScrollingModule,
  ViewportRuler
} from "./chunk-RIEUPLK3.mjs";
import {
  JobsFacade
} from "./chunk-MIES2OFH.mjs";
import {
  DirName
} from "./chunk-ZZV57LDY.mjs";
import "./chunk-TPAJ455B.mjs";
...
import {
  ...
  PortalModule,
  TemplatePortal
} from "./chunk-4TXBTXEB.mjs";
import "./chunk-JSVOQFRP.mjs";
import {
  ErrorStateMatcher,
...
} from "./chunk-DZ6AZZHK.mjs";
import {
  toSignal
} from "./chunk-CAWULYCF.mjs";
import {
  DomSanitizer
} from "./chunk-QML36CFQ.mjs";
import {
  CommonModule,
  DatePipe,
  Location,
...
// src/app/pages/application/job-tracker/add-job-modal/add-job-modal.ts
var AddJobModal = class _AddJobModal {
  data;
  modalMode = "add";
  existingJob = null;
  dialogRef = inject(MatDialogRef);
  jobForm = new FormGroup({
    ...
    dateApplied: new FormControl(null, Validators.required)
  });
  constructor(data) {
    this.data = data;
  ...
  onSubmit() {
    ...
    const normalizedDate = dateApplied instanceof Date ? dateApplied.toISOString().slice(0, 10) : dateApplied ?? "";
    if (this.modalMode === "add") {
      this.dialogRef.close({ action: "save", data: __spreadProps(__spreadValues({}, rawValue), { dateApplied: normalizedDate }) });
    } else if (this.modalMode === "edit" && this.existingJob) {
      this.dialogRef.close({
        action: "save",
        data: __spreadProps(__spreadValues({ id: this.existingJob.id }, rawValue), { dateApplied: normalizedDate })
      });
    }
  }
  static \u0275fac = function AddJobModal_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AddJobModal)(\u0275\u0275directiveInject(MAT_DIALOG_DATA));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddJobModal, selectors: [["app-add-job-modal"]], decls: 44, vars: 7, consts: [["datePicker", ""], [1, "modal-overlay"], [1, "modal-container"], [1, "modal-header"], ["aria-label", "Close modal", 1, "close-btn", 3, "click"], [3, "ngSubmit", "formGroup"], [1, "modal-body"], [1, "form-group"], ["for", "title"], ["id", "title", "type", "text", "formControlName", "title", "placeholder", "e.g. Senior Frontend Developer", "required", ""], ["for", "company"], ["id", "company", "type", "text", "formControlName", "company", "placeholder", "e.g. Tech Corp", "required", ""], ["for", "status"], ["id", "status", "formControlName", "status", "required", ""], ["value", ""], ["value", "applied"], ["value", "interviewing"], ["value", "offered"], ["value", "rejected"], ["for", "dateApplied"], ["appearance", "outline", 1, "date-picker-field"], ["id", "dateApplied", "matInput", "", "formControlName", "dateApplied", "required", "", "placeholder", "Select date", 3, "matDatepicker"], ["matIconSuffix", "", 3, "for"], ["panelClass", "cf-date-picker-panel", 3, "touchUi"], [1, "modal-footer"], ["type", "button", 1, "btn-secondary", 3, "click"], ["type", "submit", 1, "btn-primary", 3, "click", "disabled"]], template: function AddJobModal_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275listener("click", function AddJobModal_Template_button_click_5_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("ngSubmit", function AddJobModal_Template_form_ngSubmit_7_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(30, "Rejected");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(31, "div", 7)(32, "label", 19);
      \u0275\u0275text(33, "Applied Date");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "mat-form-field", 20);
      \u0275\u0275element(35, "input", 21)(36, "mat-datepicker-toggle", 22)(37, "mat-datepicker", 23, 0);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(39, "div", 24)(40, "button", 25);
      \u0275\u0275listener("click", function AddJobModal_Template_button_click_40_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeModal());
      });
      \u0275\u0275text(41, "Cancel");
      ...
      \u0275\u0275listener("click", function AddJobModal_Template_button_click_42_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSubmit());
      });
      \u0275\u0275text(43);
    ...
    if (rf & 2) {
      const datePicker_r2 = \u0275\u0275reference(38);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.modalMode === "add" ? "Add New Job" : "Edit Job");
      \u0275\u0275advance(3);
      \u0275\u0275property("formGroup", ctx.jobForm);
      \u0275\u0275advance(28);
      \u0275\u0275property("matDatepicker", datePicker_r2);
      \u0275\u0275advance();
      \u0275\u0275property("for", datePicker_r2);
      \u0275\u0275advance();
      \u0275\u0275property("touchUi", true);
      \u0275\u0275advance(5);
      \u0275\u0275property("disabled", ctx.jobForm.invalid);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.modalMode === "add" ? "Add Job" : "Save Changes", " ");
    }
  }, dependencies: [
    ReactiveFormsModule,
    \u0275NgNoValidate,
    ...
    MatIconModule,
    MatNativeDateModule
  ], styles: ["\n\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n}\n.modal-container[_ngcontent-%COMP%] {\n  background-color: white;\n  border-radius: 8px;\n  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15);\n  max-width: 500px;\n  width: 90%;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n.modal-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px;\n  border-bottom: 1px solid #e0e0e0;\n}\n.modal-header[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 1.5rem;\n  font-weight: 600;\n}\n.modal-header[_ngcontent-%COMP%]   .close-btn[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  font-size: 28px;\n  cursor: pointer;\n  color: #666;\n  padding: 0;\n  width: 32px;\n  height: 32px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.modal-header[_ngcontent-%COMP%]   .close-btn[_ngcontent-%COMP%]:hover {\n  color: #000;\n}\n.modal-body[_ngcontent-%COMP%] {\n  padding: 20px;\n}\n.form-group[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n}\n.form-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: block;\n  margin-bottom: 6px;\n  font-weight: 500;\n  font-size: 0.95rem;\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:not([type=date]):not([type=month]), \n.form-group[_ngcontent-%COMP%]   select[_ngcontent-%COMP%], \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 10px 12px;\n  border: 1px solid #d0d0d0;\n  border-radius: 4px;\n  font-size: 1rem;\n  font-family: inherit;\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:not([type=date]):not([type=month]):focus, \n.form-group[_ngcontent-%COMP%]   select[_ngcontent-%COMP%]:focus, \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--mat-sys-primary);\n  box-shadow: 0 0 0 3px rgba(var(--mat-sys-primary), 0.1);\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:not([type=date]):not([type=month]):invalid, \n.form-group[_ngcontent-%COMP%]   select[_ngcontent-%COMP%]:invalid, \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]:invalid {\n  border-color: #e74c3c;\n}\n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  resize: vertical;\n}\n[_nghost-%COMP%]     .date-picker-field {\n  width: 100%;\n}\n[_nghost-%COMP%]     .date-picker-field .mat-mdc-text-field-wrapper {\n  border-radius: 12px;\n  background: #ffffff;\n  box-shadow: 0 10px 22px rgba(15, 23, 42, 0.06);\n}\n[_nghost-%COMP%]     .date-picker-field .mdc-notched-outline__leading, \n[_nghost-%COMP%]     .date-picker-field .mdc-notched-outline__notch, \n[_nghost-%COMP%]     .date-picker-field .mdc-notched-outline__trailing {\n  border-color: #d6dfec;\n}\n[_nghost-%COMP%]     .date-picker-field.mat-focused .mdc-notched-outline__leading, \n[_nghost-%COMP%]     .date-picker-field.mat-focused .mdc-notched-outline__notch, \n[_nghost-%COMP%]     .date-picker-field.mat-focused .mdc-notched-outline__trailing {\n  border-color: #2563eb;\n}\n[_nghost-%COMP%]     .date-picker-field.mat-focused .mat-mdc-text-field-wrapper {\n  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.16), 0 8px 20px rgba(37, 99, 235, 0.16);\n}\n[_nghost-%COMP%]     .date-picker-field .mat-mdc-icon-button {\n  border-radius: 8px;\n}\n.modal-footer[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 12px;\n  justify-content: flex-end;\n  padding: 20px;\n  border-top: 1px solid #e0e0e0;\n}\n.btn-primary[_ngcontent-%COMP%], \n.btn-secondary[_ngcontent-%COMP%] {\n  padding: 10px 20px;\n  border: none;\n  border-radius: 4px;\n  font-size: 1rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n}\n.btn-primary[_ngcontent-%COMP%]:disabled, \n.btn-secondary[_ngcontent-%COMP%]:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: var(--mat-sys-primary);\n  color: white;\n}\n.btn-primary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: var(--mat-sys-primary-darken);\n}\n.btn-secondary[_ngcontent-%COMP%] {\n  background-color: #f0f0f0;\n  color: #333;\n}\n.btn-secondary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: #e0e0e0;\n}\n/*# sourceMappingURL=add-job-modal.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AddJobModal, [{
    type: Component,
    args: [{ selector: "app-add-job-modal", imports: [
      ReactiveFormsModule,
      MatDatepickerModule,
      MatFormFieldModule,
      MatInputModule,
      MatIconModule,
      MatNativeDateModule
    ], template: `<div class="modal-overlay">\r
  <div class="modal-container">\r
    <div class="modal-header">\r
      <h2>{{ modalMode === 'add' ? 'Add New Job' : 'Edit Job' }}</h2>\r
      <button class="close-btn" (click)="closeModal()" aria-label="Close modal">\xD7</button>\r
    </div>\r
\r
      ...
      <div class="modal-body">\r
        <div class="form-group">\r
          ...
          <input\r
            ...
            placeholder="e.g. Senior Frontend Developer"\r
            required\r
          />\r
        </div>\r
\r
        <div class="form-group">\r
          <label for="company">Company</label>\r
          <input\r
            id="company"\r
            type="text"\r
            formControlName="company"\r
            placeholder="e.g. Tech Corp"\r
            required\r
          />\r
        </div>\r
\r
        <div class="form-group">\r
          ...
          <select id="status" formControlName="status" required>\r
            <option value="">Select Status</option>\r
            <option value="applied">Applied</option>\r
            <option value="interviewing">Interviewing</option>\r
            <option value="offered">Offered</option>\r
            <option value="rejected">Rejected</option>\r
          </select>\r
        </div>\r
\r
        <div class="form-group">\r
          <label for="dateApplied">Applied Date</label>\r
          <mat-form-field appearance="outline" class="date-picker-field">\r
            <input\r
              id="dateApplied"\r
              matInput\r
              [matDatepicker]="datePicker"\r
              formControlName="dateApplied"\r
              required\r
              placeholder="Select date"\r
            />\r
            <mat-datepicker-toggle matIconSuffix [for]="datePicker"></mat-datepicker-toggle>\r
            <mat-datepicker\r
              #datePicker\r
              [touchUi]="true"\r
              panelClass="cf-date-picker-panel"\r
            ></mat-datepicker>\r
          </mat-form-field>\r
        </div>\r
      </div>\r
\r
      <div class="modal-footer">\r
        <button type="button" class="btn-secondary" (click)="closeModal()">Cancel</button>\r
        <button type="submit" class="btn-primary" [disabled]="jobForm.invalid" (click)="onSubmit()">\r
          {{ modalMode === 'add' ? 'Add Job' : 'Save Changes' }}\r
        </button>\r
      </div>\r
    </form>\r
  </div>\r
</div>\r
`, styles: ["/* src/app/pages/application/job-tracker/add-job-modal/add-job-modal.scss */\n.modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n}\n.modal-container {\n  background-color: white;\n  border-radius: 8px;\n  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15);\n  max-width: 500px;\n  width: 90%;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px;\n  border-bottom: 1px solid #e0e0e0;\n}\n.modal-header h2 {\n  margin: 0;\n  font-size: 1.5rem;\n  font-weight: 600;\n}\n.modal-header .close-btn {\n  background: none;\n  border: none;\n  font-size: 28px;\n  cursor: pointer;\n  color: #666;\n  padding: 0;\n  width: 32px;\n  height: 32px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.modal-header .close-btn:hover {\n  color: #000;\n}\n.modal-body {\n  padding: 20px;\n}\n.form-group {\n  margin-bottom: 16px;\n}\n.form-group label {\n  display: block;\n  margin-bottom: 6px;\n  font-weight: 500;\n  font-size: 0.95rem;\n}\n.form-group input:not([type=date]):not([type=month]),\n.form-group select,\n.form-group textarea {\n  width: 100%;\n  padding: 10px 12px;\n  border: 1px solid #d0d0d0;\n  border-radius: 4px;\n  font-size: 1rem;\n  font-family: inherit;\n}\n.form-group input:not([type=date]):not([type=month]):focus,\n.form-group select:focus,\n.form-group textarea:focus {\n  outline: none;\n  border-color: var(--mat-sys-primary);\n  box-shadow: 0 0 0 3px rgba(var(--mat-sys-primary), 0.1);\n}\n.form-group input:not([type=date]):not([type=month]):invalid,\n.form-group select:invalid,\n.form-group textarea:invalid {\n  border-color: #e74c3c;\n}\n.form-group textarea {\n  resize: vertical;\n}\n:host ::ng-deep .date-picker-field {\n  width: 100%;\n}\n:host ::ng-deep .date-picker-field .mat-mdc-text-field-wrapper {\n  border-radius: 12px;\n  background: #ffffff;\n  box-shadow: 0 10px 22px rgba(15, 23, 42, 0.06);\n}\n:host ::ng-deep .date-picker-field .mdc-notched-outline__leading,\n:host ::ng-deep .date-picker-field .mdc-notched-outline__notch,\n:host ::ng-deep .date-picker-field .mdc-notched-outline__trailing {\n  border-color: #d6dfec;\n}\n:host ::ng-deep .date-picker-field.mat-focused .mdc-notched-outline__leading,\n:host ::ng-deep .date-picker-field.mat-focused .mdc-notched-outline__notch,\n:host ::ng-deep .date-picker-field.mat-focused .mdc-notched-outline__trailing {\n  border-color: #2563eb;\n}\n:host ::ng-deep .date-picker-field.mat-focused .mat-mdc-text-field-wrapper {\n  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.16), 0 8px 20px rgba(37, 99, 235, 0.16);\n}\n:host ::ng-deep .date-picker-field .mat-mdc-icon-button {\n  border-radius: 8px;\n}\n.modal-footer {\n  display: flex;\n  gap: 12px;\n  justify-content: flex-end;\n  padding: 20px;\n  border-top: 1px solid #e0e0e0;\n}\n.btn-primary,\n.btn-secondary {\n  padding: 10px 20px;\n  border: none;\n  border-radius: 4px;\n  font-size: 1rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n}\n.btn-primary:disabled,\n.btn-secondary:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.btn-primary {\n  background-color: var(--mat-sys-primary);\n  color: white;\n}\n.btn-primary:hover:not(:disabled) {\n  background-color: var(--mat-sys-primary-darken);\n}\n.btn-secondary {\n  background-color: #f0f0f0;\n  color: #333;\n}\n.btn-secondary:hover:not(:disabled) {\n  background-color: #e0e0e0;\n}\n/*# sourceMappingURL=add-job-modal.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddJobModal, { className: "AddJobModal", filePath: "src/app/pages/application/job-tracker/add-job-modal/add-job-modal.ts", lineNumber: 24 });
})();
...
var activeCapturingEventOptions2 = {
  passive: false,
  capture: true
};
  ...
  registerDragItem(drag) {
    ...
    if (this._dragInstances.size === 1) {
      this._ngZone.runOutsideAngular(() => {
        ...
        this._cleanupDocumentTouchmove = this._renderer.listen(this._document, "touchmove", this._persistentTouchmoveListener, activeCapturingEventOptions2);
      });
    }
  }
  ...
  startDragging(drag, event) {
    ...
    if (this._activeDragInstances().length === 1) {
      ...
      const toBind = [
        ...
        ["selectstart", this._preventDefaultWhileDragging, activeCapturingEventOptions2]
      ];
      if (isTouchEvent2) {
      ...
      if (!isTouchEvent2) {
        toBind.push(["mousemove", (e) => this.pointerMove.next(e), activeCapturingEventOptions2]);
      }
      this._ngZone.runOutsideAngular(() => {
...
// src/app/lib/directives/click-outside.directive.ts
...
// src/app/pages/application/job-tracker/job-card/job-card.ts
function JobCard_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9);
    \u0275\u0275listener("clickOutside", function JobCard_div_12_Template_div_clickOutside_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleActions());
    });
    \u0275\u0275elementStart(1, "button", 10);
    \u0275\u0275listener("click", function JobCard_div_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openEditJobModal(ctx_r1.job));
    });
    ...
    \u0275\u0275listener("click", function JobCard_div_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.deleteJob(ctx_r1.job));
    });
...
function JobCard_ng_template_13_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9);
    \u0275\u0275listener("clickOutside", function JobCard_ng_template_13_div_12_Template_div_clickOutside_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleActions());
    });
    \u0275\u0275elementStart(1, "button", 10);
    \u0275\u0275listener("click", function JobCard_ng_template_13_div_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openEditJobModal(ctx_r1.job));
    });
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "button", 12);
    \u0275\u0275listener("click", function JobCard_ng_template_13_div_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteJob(ctx_r1.job));
    });
...
function JobCard_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "h4", 1);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function JobCard_ng_template_13_Template_div_click_9_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleActions());
    });
    ...
    \u0275\u0275text(11, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, JobCard_ng_template_13_div_12_Template, 11, 0, "div", 7);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.job.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.job.company, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 4, ctx_r1.job.dateApplied, "yyyy-mm-dd"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r1.showActions());
  }
}
var JobCard = class _JobCard {
  job;
  ...
  static \u0275fac = function JobCard_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _JobCard)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JobCard, selectors: [["app-job-card"]], inputs: { job: "job" }, decls: 14, vars: 7, consts: [["cdkDrag", "", "cdkDragHandle", "", 1, "job-item"], [1, "job-title"], [1, "job-company"], [1, "job-date"], [1, "job-item_actions"], ["aria-label", "Toggle job actions", 1, "menu-trigger", 3, "click"], [1, "material-symbols-outlined"], ["class", "menu", "appClickOutside", "", 3, "clickOutside", 4, "ngIf"], ["cdkDragPreview", ""], ["appClickOutside", "", 1, "menu", 3, "clickOutside"], [1, "btn", "edit-btn", 3, "click"], [1, "action-text"], [1, "btn", "delete-btn", 3, "click"], [1, "job-item", "preview"]], template: function JobCard_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 4)(9, "div", 5);
      \u0275\u0275listener("click", function JobCard_Template_div_click_9_listener() {
        return ctx.toggleActions();
      });
      \u0275\u0275elementStart(10, "span", 6);
      \u0275\u0275text(11, "more_vert");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(12, JobCard_div_12_Template, 11, 0, "div", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(13, JobCard_ng_template_13_Template, 13, 7, "ng-template", 8);
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", ctx.job.title, " ");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", ctx.job.company, " ");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 4, ctx.job.dateApplied, "yyyy-mm-dd"), " ");
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", ctx.showActions());
    }
  }, dependencies: [CommonModule, NgIf, ClickOutsideDirective, CdkDrag, DragDropModule, CdkDragHandle, CdkDragPreview, DatePipe], styles: ["\n\n.job-item[_ngcontent-%COMP%] {\n  position: relative;\n  padding: 20px;\n  font-weight: 300;\n  color: var(--text);\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  justify-content: space-between;\n  box-sizing: border-box;\n  cursor: move;\n  font-size: 14px;\n  font-family: inherit;\n  background-color: var(--surface-card);\n  border: 1px solid var(--border);\n  border-radius: 12px;\n  box-shadow: 0 8px 20px rgba(15, 23, 42, 0.08);\n}\n.job-item[_ngcontent-%COMP%]   .job-title[_ngcontent-%COMP%] {\n  font-size: 1.5em;\n}\n.job-item[_ngcontent-%COMP%]   .job-company[_ngcontent-%COMP%] {\n  font-size: 1em;\n}\n.job-item[_ngcontent-%COMP%]   .job-date[_ngcontent-%COMP%] {\n  font-size: 1em;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 20px;\n  right: 10px;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu-trigger[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  cursor: pointer;\n  color: var(--text);\n  font-size: 18px;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu-trigger[_ngcontent-%COMP%]   *[_ngcontent-%COMP%] {\n  -webkit-user-select: none;\n  user-select: none;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 0;\n  background: var(--surface-card);\n  border: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  border-radius: 8px;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu[_ngcontent-%COMP%]   .btn[_ngcontent-%COMP%] {\n  background: none;\n  padding: 15px 20px;\n  font-size: 12px;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 5px;\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu[_ngcontent-%COMP%]   .btn[_ngcontent-%COMP%]:hover {\n  background: var(--mat-sys-surface);\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu[_ngcontent-%COMP%]   .edit-btn[_ngcontent-%COMP%]   *[_ngcontent-%COMP%] {\n  color: var(--mat-sys-primary);\n}\n.job-item[_ngcontent-%COMP%]   .job-item_actions[_ngcontent-%COMP%]   .menu[_ngcontent-%COMP%]   .delete-btn[_ngcontent-%COMP%]   *[_ngcontent-%COMP%] {\n  color: var(--mat-sys-error);\n}\n.job-item.preview[_ngcontent-%COMP%] {\n  background: var(--surface-card);\n  border-radius: 12px;\n  box-shadow: 0 16px 30px rgba(15, 23, 42, 0.2);\n}\n.cdk-drag-preview[_ngcontent-%COMP%] {\n  box-sizing: border-box;\n  border-radius: 4px;\n  box-shadow:\n    0 5px 5px -3px rgba(0, 0, 0, 0.2),\n    0 8px 10px 1px rgba(0, 0, 0, 0.14),\n    0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n.cdk-drag-placeholder[_ngcontent-%COMP%] {\n  opacity: 0;\n}\n.cdk-drag-animating[_ngcontent-%COMP%] {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n.example-box[_ngcontent-%COMP%]:last-child {\n  border: none;\n}\n.example-list.cdk-drop-list-dragging[_ngcontent-%COMP%]   .example-box[_ngcontent-%COMP%]:not(.cdk-drag-placeholder) {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=job-card.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(JobCard, [{
    type: Component,
    args: [{ selector: "app-job-card", imports: [DatePipe, CommonModule, ClickOutsideDirective, CdkDrag, DragDropModule], template: `<div class="job-item" cdkDrag cdkDragHandle>\r
  <h4 class="job-title">\r
    {{ job.title }}\r
  </h4>\r
  <p class="job-company">\r
    {{ job.company }}\r
  </p>\r
  <p class="job-date">\r
    {{ job.dateApplied | date: 'yyyy-mm-dd' }}\r
  </p>\r
\r
  <div class="job-item_actions">\r
    <div class="menu-trigger" (click)="toggleActions()" aria-label="Toggle job actions">\r
      <span class="material-symbols-outlined">more_vert</span>\r
    </div>\r
    <div class="menu" *ngIf="showActions()" appClickOutside (clickOutside)="toggleActions()">\r
      <button class="btn edit-btn" (click)="openEditJobModal(job)">\r
        <span class="material-symbols-outlined">edit</span>\r
        <p class="action-text">Edit</p>\r
      </button>\r
      <button class="btn delete-btn" (click)="deleteJob(job)">\r
        <span class="material-symbols-outlined">delete</span>\r
        <p class="action-text">Delete</p>\r
      </button>\r
    </div>\r
  </div>\r
</div>\r
\r
<ng-template cdkDragPreview>\r
  <div class="job-item preview">\r
    <h4 class="job-title">\r
      {{ job.title }}\r
    </h4>\r
    <p class="job-company">\r
    ...
    <div class="job-item_actions">\r
      <div\r
        class="menu-trigger"\r
        (click)="toggleActions()"\r
        aria-label="Toggle job actions"\r
      >\r
        <span class="material-symbols-outlined">more_vert</span>\r
      </div>\r
      <div class="menu" *ngIf="showActions()" appClickOutside (clickOutside)="toggleActions()">\r
...
`, styles: ["/* src/app/pages/application/job-tracker/job-card/job-card.scss */\n.job-item {\n  position: relative;\n  padding: 20px;\n  font-weight: 300;\n  color: var(--text);\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  justify-content: space-between;\n  box-sizing: border-box;\n  cursor: move;\n  font-size: 14px;\n  font-family: inherit;\n  background-color: var(--surface-card);\n  border: 1px solid var(--border);\n  border-radius: 12px;\n  box-shadow: 0 8px 20px rgba(15, 23, 42, 0.08);\n}\n.job-item .job-title {\n  font-size: 1.5em;\n}\n.job-item .job-company {\n  font-size: 1em;\n}\n.job-item .job-date {\n  font-size: 1em;\n}\n.job-item .job-item_actions {\n  position: absolute;\n  top: 20px;\n  right: 10px;\n}\n.job-item .job-item_actions .menu-trigger {\n  background: none;\n  border: none;\n  cursor: pointer;\n  color: var(--text);\n  font-size: 18px;\n}\n.job-item .job-item_actions .menu-trigger * {\n  -webkit-user-select: none;\n  user-select: none;\n}\n.job-item .job-item_actions .menu {\n  position: absolute;\n  right: 0;\n  background: var(--surface-card);\n  border: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  border-radius: 8px;\n}\n.job-item .job-item_actions .menu .btn {\n  background: none;\n  padding: 15px 20px;\n  font-size: 12px;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 5px;\n}\n.job-item .job-item_actions .menu .btn:hover {\n  background: var(--mat-sys-surface);\n}\n.job-item .job-item_actions .menu .edit-btn * {\n  color: var(--mat-sys-primary);\n}\n.job-item .job-item_actions .menu .delete-btn * {\n  color: var(--mat-sys-error);\n}\n.job-item.preview {\n  background: var(--surface-card);\n  border-radius: 12px;\n  box-shadow: 0 16px 30px rgba(15, 23, 42, 0.2);\n}\n.cdk-drag-preview {\n  box-sizing: border-box;\n  border-radius: 4px;\n  box-shadow:\n    0 5px 5px -3px rgba(0, 0, 0, 0.2),\n    0 8px 10px 1px rgba(0, 0, 0, 0.14),\n    0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n.cdk-drag-placeholder {\n  opacity: 0;\n}\n.cdk-drag-animating {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n.example-box:last-child {\n  border: none;\n}\n.example-list.cdk-drop-list-dragging .example-box:not(.cdk-drag-placeholder) {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=job-card.css.map */\n"] }]
  }], null, { job: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JobCard, { className: "JobCard", filePath: "src/app/pages/application/job-tracker/job-card/job-card.ts", lineNumber: 16 });
})();

// src/app/pages/application/job-tracker/job-tracker.ts
var _c03 = ["actionsMenu"];
var _c12 = (a0, a1, a2) => [a0, a1, a2];
var _forTrack02 = ($index, $item) => $item.id;
function JobTracker_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-job-card", 11);
  }
  if (rf & 2) {
    const job_r2 = ctx.$implicit;
    \u0275\u0275property("job", job_r2);
  }
}
function JobTracker_For_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-job-card", 11);
  }
  if (rf & 2) {
    const job_r3 = ctx.$implicit;
    \u0275\u0275property("job", job_r3);
  }
}
function JobTracker_For_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-job-card", 11);
  }
  if (rf & 2) {
    const job_r4 = ctx.$implicit;
    \u0275\u0275property("job", job_r4);
  }
}
function JobTracker_For_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-job-card", 11);
  }
  if (rf & 2) {
    const job_r5 = ctx.$implicit;
    \u0275\u0275property("job", job_r5);
  }
}
var JobTracker = class _JobTracker {
  sanitizer;
  htmlContent;
  dialog = inject(MatDialog);
  jobsFacade = inject(JobsFacade);
  jobs = toSignal(this.jobsFacade.jobs$, { initialValue: [] });
  appliedJobs = computed(() => this.jobs().filter((job) => job.status === "applied"), ...ngDevMode ? [{ debugName: "appliedJobs" }] : []);
  interviewingJobs = computed(() => this.jobs().filter((job) => job.status === "interviewing"), ...ngDevMode ? [{ debugName: "interviewingJobs" }] : []);
  offerJobs = computed(() => this.jobs().filter((job) => job.status === "offered"), ...ngDevMode ? [{ debugName: "offerJobs" }] : []);
  rejectedJobs = computed(() => this.jobs().filter((job) => job.status === "rejected"), ...ngDevMode ? [{ debugName: "rejectedJobs" }] : []);
  constructor(sanitizer) {
    this.sanitizer = sanitizer;
    this.htmlContent = this.sanitizer.bypassSecurityTrustHtml(`<button class="add-job-btn" type="button" aria-label="Add Job">
  ...
  handleJobAdded(newJob) {
    const status = newJob.status || "applied";
    const groupedJobs = this.jobs().filter((job) => job.status === status);
    const jobPayload = {
      title: newJob.title || "Untitled",
      company: newJob.company || "",
      status,
      dateApplied: newJob.dateApplied || (/* @__PURE__ */ new Date()).toISOString(),
  ...
  drop(event) {
    if (event.previousContainer === event.container) {
      ...
      const updatedJob = __spreadProps(__spreadValues({}, movedJob), { status: this.getStatusFromId(event.container.id) });
  ...
  getStatusFromId(id) {
    if (id.includes("applied"))
      return "applied";
    if (id.includes("interviewing"))
      return "interviewing";
    if (id.includes("offered"))
      return "offered";
    if (id.includes("rejected"))
      return "rejected";
    return "applied";
  }
  getReorderedJobs(event) {
  ...
  static \u0275fac = function JobTracker_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _JobTracker)(\u0275\u0275directiveInject(DomSanitizer));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JobTracker, selectors: [["app-job-tracker"]], viewQuery: function JobTracker_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c03, 5);
    }
    if (rf & 2) {
      let _t;
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.actionsMenu = _t.first);
    }
  }, decls: 35, vars: 24, consts: [["appliedList", "cdkDropList"], ["interviewingList", "cdkDropList"], ["offerList", "cdkDropList"], ["rejectedList", "cdkDropList"], [1, "job-tracker", "container"], ["title", "Job Application Tracker", 3, "additionalElemClicked"], ["type", "button", "aria-label", "Add Job", 1, "add-job-btn", 3, "click"], [1, "btn-icon"], [1, "app-section"], [1, "applied-list", "jobs-list"], ["id", "applied", "cdkDropList", "", 1, "applied-items", "list", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], [3, "job"], [1, "interviewing-list", "jobs-list"], ["id", "interviewing", "cdkDropList", "", 1, "interviewing-items", "list", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], [1, "offer-list", "jobs-list"], ["id", "offered", "cdkDropList", "", 1, "offer-items", "list", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], [1, "rejected-list", "jobs-list"], ["id", "rejected", "cdkDropList", "", 1, "rejected-items", "list", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"]], template: function JobTracker_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 4)(1, "app-dir-name", 5);
      \u0275\u0275listener("additionalElemClicked", function JobTracker_Template_app_dir_name_additionalElemClicked_1_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openAddJobModal());
      });
      \u0275\u0275elementStart(2, "button", 6);
      \u0275\u0275listener("click", function JobTracker_Template_button_click_2_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openAddJobModal());
      });
      ...
      \u0275\u0275text(5, " Add Job ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 8)(7, "div", 9)(8, "h2");
      \u0275\u0275text(9, "Applied");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "div", 10, 0);
      \u0275\u0275listener("cdkDropListDropped", function JobTracker_Template_div_cdkDropListDropped_10_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.drop($event));
      });
      \u0275\u0275repeaterCreate(12, JobTracker_For_13_Template, 1, 1, "app-job-card", 11, _forTrack02);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "div", 12)(15, "h2");
      \u0275\u0275text(16, "Interviewing");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 13, 1);
      \u0275\u0275listener("cdkDropListDropped", function JobTracker_Template_div_cdkDropListDropped_17_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.drop($event));
      });
      \u0275\u0275repeaterCreate(19, JobTracker_For_20_Template, 1, 1, "app-job-card", 11, _forTrack02);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(21, "div", 14)(22, "h2");
      \u0275\u0275text(23, "Offer");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 15, 2);
      \u0275\u0275listener("cdkDropListDropped", function JobTracker_Template_div_cdkDropListDropped_24_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.drop($event));
      });
      \u0275\u0275repeaterCreate(26, JobTracker_For_27_Template, 1, 1, "app-job-card", 11, _forTrack02);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(28, "div", 16)(29, "h2");
      \u0275\u0275text(30, "Rejected");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "div", 17, 3);
      \u0275\u0275listener("cdkDropListDropped", function JobTracker_Template_div_cdkDropListDropped_31_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.drop($event));
      });
      \u0275\u0275repeaterCreate(33, JobTracker_For_34_Template, 1, 1, "app-job-card", 11, _forTrack02);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      const appliedList_r6 = \u0275\u0275reference(11);
      const interviewingList_r7 = \u0275\u0275reference(18);
      const offerList_r8 = \u0275\u0275reference(25);
      const rejectedList_r9 = \u0275\u0275reference(32);
      \u0275\u0275advance(10);
      \u0275\u0275property("cdkDropListData", ctx.appliedJobs())("cdkDropListConnectedTo", \u0275\u0275pureFunction3(8, _c12, interviewingList_r7, offerList_r8, rejectedList_r9));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.appliedJobs());
      \u0275\u0275advance(5);
      \u0275\u0275property("cdkDropListData", ctx.interviewingJobs())("cdkDropListConnectedTo", \u0275\u0275pureFunction3(12, _c12, appliedList_r6, offerList_r8, rejectedList_r9));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.interviewingJobs());
      \u0275\u0275advance(5);
      \u0275\u0275property("cdkDropListData", ctx.offerJobs())("cdkDropListConnectedTo", \u0275\u0275pureFunction3(16, _c12, appliedList_r6, interviewingList_r7, rejectedList_r9));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.offerJobs());
      \u0275\u0275advance(5);
      \u0275\u0275property("cdkDropListData", ctx.rejectedJobs())("cdkDropListConnectedTo", \u0275\u0275pureFunction3(20, _c12, appliedList_r6, interviewingList_r7, offerList_r8));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.rejectedJobs());
    }
  }, dependencies: [DirName, DragDropModule, CdkDropList, CommonModule, JobCard], styles: ["/* src/app/pages/application/job-tracker/job-tracker.scss */\n.app-section {\n  width: 100%;\n  height: calc(100% - 80px);\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 5vh 2vw;\n  align-items: start;\n}\n.app-section .jobs-list {\n  max-width: 100%;\n  height: 100%;\n  display: inline-block;\n  vertical-align: top;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  align-items: center;\n  justify-content: center;\n  width: 23%;\n}\n.app-section .jobs-list .list {\n  height: 100%;\n  border-radius: 4px;\n  overflow: hidden;\n  font-family: sans-serif;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  gap: 1vh;\n}\n.app-section .jobs-list h2 {\n  width: 100%;\n  text-align: left;\n}\n/*# sourceMappingURL=job-tracker.css.map */\n"], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(JobTracker, [{
    type: Component,
    args: [{ selector: "app-job-tracker", imports: [DirName, DragDropModule, CommonModule, JobCard], encapsulation: ViewEncapsulation.None, template: '<div class="job-tracker container">\r\n  <app-dir-name title="Job Application Tracker" (additionalElemClicked)="openAddJobModal()">\r\n    <button class="add-job-btn" type="button" aria-label="Add Job" (click)="openAddJobModal()">\r\n      <span class="btn-icon">+</span>\r\n      Add Job\r\n    </button></app-dir-name\r\n  >\r\n  <div class="app-section">\r\n    <div class="applied-list jobs-list">\r\n      <h2>Applied</h2>\r\n      <div\r\n        id="applied"\r\n        class="applied-items list"\r\n        cdkDropList\r\n        #appliedList="cdkDropList"\r\n        [cdkDropListData]="appliedJobs()"\r\n        [cdkDropListConnectedTo]="[interviewingList, offerList, rejectedList]"\r\n        (cdkDropListDropped)="drop($event)"\r\n      >\r\n        @for (job of appliedJobs(); track job.id) {\r\n          <app-job-card [job]="job"></app-job-card>\r\n        }\r\n      </div>\r\n    </div>\r\n    <div class="interviewing-list jobs-list">\r\n      <h2>Interviewing</h2>\r\n      <div\r\n        id="interviewing"\r\n        class="interviewing-items list"\r\n        cdkDropList\r\n        #interviewingList="cdkDropList"\r\n        [cdkDropListData]="interviewingJobs()"\r\n        [cdkDropListConnectedTo]="[appliedList, offerList, rejectedList]"\r\n        (cdkDropListDropped)="drop($event)"\r\n      >\r\n        @for (job of interviewingJobs(); track job.id) {\r\n          <app-job-card [job]="job"></app-job-card>\r\n        }\r\n      </div>\r\n    </div>\r\n    <div class="offer-list jobs-list">\r\n      <h2>Offer</h2>\r\n      <div\r\n        id="offered"\r\n        class="offer-items list"\r\n        cdkDropList\r\n        #offerList="cdkDropList"\r\n        [cdkDropListData]="offerJobs()"\r\n        [cdkDropListConnectedTo]="[appliedList, interviewingList, rejectedList]"\r\n        (cdkDropListDropped)="drop($event)"\r\n      >\r\n        @for (job of offerJobs(); track job.id) {\r\n          <app-job-card [job]="job"></app-job-card>\r\n        }\r\n      </div>\r\n    </div>\r\n    <div class="rejected-list jobs-list">\r\n      <h2>Rejected</h2>\r\n      <div\r\n        id="rejected"\r\n        class="rejected-items list"\r\n        cdkDropList\r\n        #rejectedList="cdkDropList"\r\n        [cdkDropListData]="rejectedJobs()"\r\n        [cdkDropListConnectedTo]="[appliedList, interviewingList, offerList]"\r\n        (cdkDropListDropped)="drop($event)"\r\n      >\r\n        @for (job of rejectedJobs(); track job.id) {\r\n          <app-job-card [job]="job"></app-job-card>\r\n        }\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n', styles: ["/* src/app/pages/application/job-tracker/job-tracker.scss */\n.app-section {\n  width: 100%;\n  height: calc(100% - 80px);\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 5vh 2vw;\n  align-items: start;\n}\n.app-section .jobs-list {\n  max-width: 100%;\n  height: 100%;\n  display: inline-block;\n  vertical-align: top;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  align-items: center;\n  justify-content: center;\n  width: 23%;\n}\n.app-section .jobs-list .list {\n  height: 100%;\n  border-radius: 4px;\n  overflow: hidden;\n  font-family: sans-serif;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  gap: 1vh;\n}\n.app-section .jobs-list h2 {\n  width: 100%;\n  text-align: left;\n}\n/*# sourceMappingURL=job-tracker.css.map */\n"] }]
  }], () => [{ type: DomSanitizer }], { actionsMenu: [{
    type: ViewChild,
    args: ["actionsMenu"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JobTracker, { className: "JobTracker", filePath: "src/app/pages/application/job-tracker/job-tracker.ts", lineNumber: 35 });
})();
export {
  JobTracker
};
//# sourceMappingURL=chunk-4MLETA7Z.mjs.map

...
function updateEmulatorBanner(name6, isRunningEmulator) {
  if (typeof window === "undefined" || typeof document === "undefined" || !isCloudWorkstation(window.location.host) || emulatorStatus[name6] === isRunningEmulator || emulatorStatus[name6] || // If already set to use emulator, can't go back to prod.
  previouslyDismissed) {
    return;
  }
  emulatorStatus[name6] = isRunningEmulator;
...
function httpsCallable2(functions, name6, options) {
  var callable = httpsCallable(functions, name6, options);
...
var FunctionsModule = class _FunctionsModule {
  constructor() {
    registerVersion("angularfire", VERSION2.full, "fn");
  }
...
@firebase/functions/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XZHX3JZA.mjs.map

...
var APPLICATION_ROUTES = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-7JJINJV7.mjs").then((c) => c.Application),
    canActivate: [AuthGuard],
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-HNC7KXMY.mjs").then((c) => c.Dashboard),
        data: {
          seo: {
      ...
      {
        path: "settings",
        loadComponent: () => import("./chunk-RCSDKYHA.mjs").then((c) => c.Settings),
        data: {
          seo: {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-ZBESBUTY.mjs").then((c) => c.ResumesEdit),
        data: {
          seo: {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-4I3OPEZO.mjs").then((c) => c.ResumesTailor),
        data: {
          seo: {
      ...
      {
        path: "resumes",
        loadComponent: () => import("./chunk-ZEVXUNBH.mjs").then((c) => c.Resumes),
        data: {
          seo: {
      ...
      {
        path: "cover-letter",
        loadComponent: () => import("./chunk-EAOIJNWT.mjs").then((c) => c.CoverLetter),
        data: {
          seo: {
      ...
      {
        path: "job-tracker",
        loadComponent: () => import("./chunk-DV5FWXZJ.mjs").then((c) => c.JobTracker),
        data: {
          seo: {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-2NKEGHZW.mjs").then((c) => c.InterviewCoach),
        data: {
          seo: {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-FGVENN5Z.mjs").then((c) => c.Linkedin),
        data: {
          seo: {
  ...
  }, true ? { \u0275entryName: "src/app/pages/application/application.ts" } : {})
];
export {
  APPLICATION_ROUTES
};
//# sourceMappingURL=chunk-72FWEVWL.mjs.map

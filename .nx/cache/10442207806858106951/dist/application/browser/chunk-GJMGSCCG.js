...
var JobCard = class _JobCard {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JobCard, selectors: [["app-job-card"]], inputs: { job: "job" }, decls: 14, vars: 7, consts: [["cdkDrag", "", "cdkDragHandle", "", 1, "interviewing", "job-item"], [1, "job-title"], [1, "job-company"], [1, "job-date"], [1, "job-item_actions"], ["aria-label", "Toggle job actions", 1, "menu-trigger", 3, "click"], [1, "material-symbols-outlined"], ["class", "menu", "appClickOutside", "", 3, "clickOutside", 4, "ngIf"], ["cdkDragPreview", "", "cdkDragHandle", ""], ["appClickOutside", "", 1, "menu", 3, "clickOutside"], [1, "btn", "edit-btn", 3, "click"], [1, "action-text"], [1, "btn", "delete-btn", 3, "click"], [1, "job-item", "preview"]], template: function JobCard_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(JobCard, [{
    type: Component,
    args: [{ selector: "app-job-card", imports: [DatePipe, CommonModule, ClickOutsideDirective, CdkDrag, DragDropModule], template: `<div class="interviewing job-item" cdkDrag cdkDragHandle>\r
...
\r
<ng-template cdkDragPreview cdkDragHandle>\r
...
//# sourceMappingURL=chunk-GJMGSCCG.js.map

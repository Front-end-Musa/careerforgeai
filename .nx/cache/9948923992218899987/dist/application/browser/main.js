...
var routes = [
  ...
  __spreadValues({
    path: "application",
    loadChildren: () => import("./chunk-M6LVKNQ7.js").then((r) => r.APPLICATION_ROUTES),
    data: {
      seo: {
...
var AuthService = class _AuthService {
  ...
  deleteAccount() {
    ...
    return from(deleteUser(currentUser)).pipe(catchError((err) => {
...
var AuthEffects = class _AuthEffects {
  ...
  deleteAccountEffect = createEffect(() => this.actions$.pipe(ofType(deleteAccount), tap(() => this.authService$.deleteAccount().pipe(map(() => deleteAccountSuccess()), catchError((error) => of(deleteAccountFailure({ error: error.message })))))));
